const vocabLevelA1 = [
  ...
  {
    id: "a1-set-9",
    name: { en: "Set 9: Colors", fa: "مجموعه ۹: رنگ‌ها" },
    words: [
      { id: "a1-s9-w1", en: "red", fa: "قرمز", examples: ["The apple is red.", "She is wearing a red dress."] },
      { id: "a1-s9-w2", en: "blue", fa: "آبی", examples: ["The sky is blue.", "He has a blue car."] },
      { id: "a1-s9-w3", en: "green", fa: "سبز", examples: ["The grass is green.", "I like the green shirt."] },
      { id: "a1-s9-w4", en: "yellow", fa: "زرد", examples: ["The sun is yellow.", "She bought a yellow bag."] },
      { id: "a1-s9-w5", en: "black", fa: "سیاه", examples: ["He has a black cat.", "I wear black shoes."] },
      { id: "a1-s9-w6", en: "white", fa: "سفید", examples: ["The walls are white.", "She has a white shirt."] },
      { id: "a1-s9-w7", en: "orange", fa: "نارنجی", examples: ["I like orange juice.", "The leaves turned orange."] },
      { id: "a1-s9-w8", en: "purple", fa: "بنفش", examples: ["She wore a purple dress.", "The flower is purple."] },
